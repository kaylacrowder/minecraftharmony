...
def lambda_handler(event, context):
    ...
    if current_time >= datetime.time(3, 0) or current_time < datetime.time(13, 0):
        if instance_state == 'running':
            ...
            return f'Instance stopped successfully {current_time}'
            ...
            if instance_state == 'stopped':
                ...
                return f'Instance started successfully {current_time}'
        #elif instance_state == 'running':
            #return f'Instance is already started {current_time}'
            else:
                return f'Instance is in {instance_state} state and cannot be started or stopped {current_time}'
